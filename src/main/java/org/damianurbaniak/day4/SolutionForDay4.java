...
public class SolutionForDay4 {
    public static void main(String[] args) throws FileNotFoundException {
        final List<int[][]> inputDay4_tables =
                ConvertInputDay4.tablesForDay4("src/main/java/org/damianurbaniak/day4/inputDay4_tables");
        final List<Integer> inputDay4_numbers =
                ConvertInputDay4.numbersForDay4("src/main/java/org/damianurbaniak/day4/inputDay4_numbers");
